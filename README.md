...
|      Get Token      |      `GET`       |       localhost:8080/token        |                                                                                                                 | {<br>"access_token": `"string"`,<br>"token_type": `"Bearer"`,<br>"account": <br>{<br>"id": `0`,<br>"full_name": `"string"`,<br>"email": `"string"`,<br>"zipcode": `"string"`<br>}<br>} |
...
|     Logout Page     |     `DELETE`     |       localhost:8080/token        |                                                                                                                 | {<br>`true`<br>}                                                                                                                                                                       |
